        ...
        <form onSubmit={handleSubmit} id="user-form" className="shadow-lg shadow-slate-400 basis-5/12 bg-gradient-to-br from-slate-50 to-slate-200 mb-4 p-4 xl:basis-5/12">
          <div className="flex flex-col justify-center lg:flex-row md:justify-between">
            <div className="user-dims flex flex-col justify-center items-center lg:justify-start lg:items-start">
              ...
              <input type="number" className="border-solid border border-slate-400 pl-2 w-48 sm:w-40 lg:w-36 mb-4 mt-1 placeholder:text-slate-500" placeholder="Inches only" value={state.height} onChange={e => state.setHeight(e.target.value)} ref={heightRef} />
            </div>
            <div className="user-dims flex flex-col justify-center items-center lg:justify-start lg:items-start">
              <label className="text-black text-xl lg:text-base" htmlFor="body-width">
                Body width:{" "}
              </label>
              <input type="number" className="border-solid border border-slate-400 pl-2 w-48 sm:w-40 lg:w-36 mb-4 mt-1 placeholder:text-slate-500" placeholder="Inches only" value={state.bodyWidth} onChange={e => state.setBodyWidth(e.target.value)} />
            </div>
          </div>
          <div className="flex flex-col justify-center lg:flex-row md:justify-between">
            <div className="user-dims flex flex-col justify-center items-center lg:justify-start lg:items-start">
              ...
              <input type="number" className="border-solid border border-slate-400 pl-2 w-48 sm:w-40 lg:w-36 mb-4 mt-1 placeholder:text-slate-500" placeholder="Inches only" value={state.chairHeight} onChange={e => state.setChairHeight(e.target.value)} />
            </div>
            <div className="user-dims flex flex-col justify-center items-center lg:justify-start lg:items-start">
              <label className="text-black text-xl lg:text-base" htmlFor="chair-depth">
                Chair sit depth:{" "}
              </label>
              <input type="number" className="border-solid border border-slate-400 pl-2 w-48 sm:w-40 lg:w-36 mb-4 mt-1 placeholder:text-slate-500" placeholder="Inches only" value={state.chairDepth} onChange={e => state.setChairDepth(e.target.value)} />
            </div>
          </div>
          <div className="flex flex-col justify-center lg:flex-row md:justify-between">
            <div className="user-dims flex flex-col justify-center items-center lg:justify-start lg:items-start">
              ...
              <input type="number" className="border-solid border border-slate-400 pl-2 w-48 sm:w-40 lg:w-36 mb-4 mt-1 placeholder:text-slate-500" placeholder="Feet only" value={state.tarpLength} onChange={e => state.setTarpLength(e.target.value)} />
            </div>
            <div className="user-dims flex flex-col justify-center items-center lg:justify-start lg:items-start">
              <label className="text-left text-black text-xl lg:text-base" htmlFor="tarp-width">
                Tarp Width:
              </label>
              <input type="number" className="border-solid border border-slate-400 pl-2 w-48 sm:w-40 lg:w-36 mb-4 mt-1 placeholder:text-slate-500" placeholder="Feet only" value={state.tarpWidth} onChange={e => state.setTarpWidth(e.target.value)} />
            </div>
          </div>
